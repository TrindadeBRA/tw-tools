...
export const metadata: Metadata = {
    title: "Download Concluído | Arquivos .CSV para Teste - TW Tools",
    description: "Confirmação de download de arquivo .CSV de teste",
};
...
export default function DownloadPage() {
    const breadcrumbs = [
        ...
        {
            name: 'Download',
            href: '/arquivos-testes/csv/download',
            current: true
        }
    ];
    ...
    return (
        <>
            <Header
                ...
                title="Arquivo .CSV Baixado com Sucesso"
                description="Seu arquivo .CSV de teste foi baixado com sucesso"
