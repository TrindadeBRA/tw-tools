...
export const metadata: Metadata = {
    title: "Download Concluído | Arquivos .PPTX para Teste - TW Tools",
    description: "Confirmação de download de arquivo .PPTX de teste",
};
...
export default function DownloadPage() {
    const breadcrumbs = [
        ...
        {
            name: 'Download',
            href: '/arquivos-testes/pptx/download',
            current: true
        }
    ];
    ...
    return (
        <>
            <Header
                ...
                title="Arquivo .PPTX Baixado com Sucesso"
                description="Seu arquivo .PPTX de teste foi baixado com sucesso"
