...
export const metadata: Metadata = {
    title: "Download Concluído | Arquivos .RTF para Teste - TW Tools",
    description: "Confirmação de download de arquivo .RTF de teste",
};
...
export default function DownloadPage() {
    const breadcrumbs = [
        ...
        {
            name: 'Download',
            href: '/arquivos-testes/rtf/download',
            current: true
        }
    ];
    ...
    return (
        <>
            <Header
                ...
                title="Arquivo .RTF Baixado com Sucesso"
                description="Seu arquivo .RTF de teste foi baixado com sucesso"
