...
export const metadata: Metadata = {
    title: "Download Concluído | Arquivos .XLSX para Teste - TW Tools",
    description: "Confirmação de download de arquivo .XLSX de teste",
};
...
export default function DownloadPage() {
    const breadcrumbs = [
        ...
        {
            name: 'Download',
            href: '/arquivos-testes/xlsx/download',
            current: true
        }
    ];
    ...
    return (
        <>
            <Header
                ...
                title="Arquivo .XLSX Baixado com Sucesso"
                description="Seu arquivo .XLSX de teste foi baixado com sucesso"
